...
def on_inventory_log_saved(sender: object, instance: InventoryLog, **_kwargs: object) -> None:
...
def on_forecast_saved(sender: object, instance: Forecast, **_kwargs: object) -> None:
...
def on_anomaly_alert_saved(sender: object, instance: AnomalyAlert, **_kwargs: object) -> None:
...
def on_facility_saved(sender: object, instance: Facility, **_kwargs: object) -> None:
